...
function expandAliasTokens(tokens, aliases = {}) {
...
function buildSemanticQueryProfile(query = {}) {
  ...
  const expandedTokens = expandAliasTokens(baseTokens, semanticConfig.aliases);
...
function buildExperienceSemanticDocument(experience, semanticConfig) {
  ...
  return {
    tokens: expandAliasTokens(baseTokens, semanticConfig.aliases),
